...
if __name__ == '__main__':
	...
	get_all_tweets("andsharper22")
	get_all_tweets("_depression99_")
	get_all_tweets("Depression199x")
	get_all_tweets("ed_depression")
	get_all_tweets("F_ckDepression")
	get_all_tweets("BeyondBrokenDep")
	get_all_tweets("garyhgoodridge")
